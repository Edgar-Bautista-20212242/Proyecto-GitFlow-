...
public class ProductosPanel extends JPanel {
	...
	public ProductosPanel() {
		...
		JLabel LabelTop = new JLabel("Productos");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "Nombre", "Stock", "Precio", "IDSuplidor"
			}
		));
		...
		ImageIcon IAC = new ImageIcon("Media/AgregarP.png");
		...
		BTNAgregar.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) 
			{
				...
				ImageIcon IAC = new ImageIcon("Media/AgregarP E.png");
				LabelAg.setIcon(new ImageIcon(IAC.getImage().getScaledInstance(32, 32, Image.SCALE_SMOOTH)));
			...
			{
				ProductoAgregar p = new ProductoAgregar();
				CambiarPanel(p);
			}
		});
		...
		ImageIcon ICM= new ImageIcon("Media/EditarP.png");  
		...
		BTNMod.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) 
			{
				...
				ImageIcon ICM= new ImageIcon("Media/EditarP E.png");  
				LabelMod.setIcon(new ImageIcon(ICM.getImage().getScaledInstance(32, 32, Image.SCALE_SMOOTH))); 
			...
			public void mousePressed(MouseEvent e)
			{
				ProductoModificar p = new ProductoModificar();
				CambiarPanel(p);
			}
		});
		BTNMod.add(LabelMod);
		...
		ImageIcon ICE = new ImageIcon("Media/EliminarP.png");
		...
		BTNEl.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) 
			{
				...
				ImageIcon ICE = new ImageIcon("Media/EliminarP E.png");
				LabelEL.setIcon(new ImageIcon(ICE.getImage().getScaledInstance(36, 36, Image.SCALE_SMOOTH))); 
			...
			public void mousePressed(MouseEvent e)
			{
				ProductosEliminar p = new ProductosEliminar();
				CambiarPanel(p);
			}
		});
		BTNEl.add(LabelEL);
