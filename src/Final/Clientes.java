...
public class Clientes extends JPanel {
	...
	public Clientes() {
		...
		JLabel LabelTop = new JLabel("Clientes");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "Nombre", "Telefono", "Direccion", "Cedula"
			}
		));
		...
		ImageIcon ICA = new ImageIcon("Media/AgregarCliente.png");
		...
		BTNAgregar.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) 
			{
				...
				ImageIcon ICA = new ImageIcon("Media/AgregarCliente E.png");
				LabelAg.setIcon(new ImageIcon(ICA.getImage().getScaledInstance(32, 32, Image.SCALE_SMOOTH)));
			...
			{
				ClienteAgregar p = new ClienteAgregar();
				CambiarPanel(p);
			}
		});
		...
		ImageIcon ICM = new ImageIcon("Media/EditarCliente.png");
		...
		BTNMod.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) 
			{
				...
				ImageIcon ICM = new ImageIcon("Media/EditarCliente E.png");
				LabelMod.setIcon(new ImageIcon(ICM.getImage().getScaledInstance(32, 32, Image.SCALE_SMOOTH))); 
			...
			public void mousePressed(MouseEvent e)
			{
				ClienteModificar p = new ClienteModificar();
				CambiarPanel(p);
			}
		});
		BTNMod.add(LabelMod);
		...
		ImageIcon ICE= new ImageIcon("Media/EliminarCliente.png");
		...
		BTNEl.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) 
			{
				...
				ImageIcon ICE= new ImageIcon("Media/EliminarCliente E.png");
				LabelEL.setIcon(new ImageIcon(ICE.getImage().getScaledInstance(32, 32, Image.SCALE_SMOOTH)));
			...
			public void mousePressed(MouseEvent e)
			{
				ClienteEliminar p = new ClienteEliminar();
				CambiarPanel(p);
			}
		});
		BTNEl.add(LabelEL);
